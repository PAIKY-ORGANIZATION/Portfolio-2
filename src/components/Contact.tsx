...
export default function Contact() {
	...
	return (
		<section id="contact" className="bg-[#1E1E1E] text-white py-16 px-4">
				...
				<div>
					<form className="space-y-6" onSubmit={onSubmit}>
						<div>
							...
							<input  name="name"  type="text" className="w-full bg-transparent border-b border-gray-500 focus:outline-none py-2" required/>
						</div>
						<div>
							<label  className="block text-sm uppercase tracking-wide mb-1"> Email: </label>
							<input  name="email" type="email" className="w-full bg-transparent border-b border-gray-500 focus:outline-none py-2" required/>
						</div>
						<div>
							<label className="block text-sm uppercase tracking-wide mb-1"> Message: </label>
							<textarea  name="message" rows={4} className="w-full bg-transparent border-b border-gray-500 focus:outline-none py-2 resize-none" required />
						</div>
